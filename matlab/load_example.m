...
folder_frame = [dataset_root 'Video_files/', person_id,'/',action_id,'/',rep,'/'];
folder_pose =  [dataset_root 'Hand_pose_annotation_v1/', person_id,'/',action_id,'/',rep,'/'];
